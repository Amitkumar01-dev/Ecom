<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SellsInvoice.aspx.cs" Inherits="SellsInvoice" %>
                ...
                <div class="col-sm-3">
                    <div class="md-float-material form-material">
                        <div class="form-group form-primary">
                            ...
                            <span class="form-bar"></span>
                            <%--<asp:Label ID="lblmarkname" runat="server" CssClass="float-label" Text="*" ForeColor="Red"></asp:Label>--%>
                            <asp:Label ID="lblCustName" runat="server" CssClass="float-label ml-2" Text="Customer Name"></asp:Label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="md-float-material form-material">
                        <div class="form-group form-primary">
                            ...
                            <span class="form-bar"></span>
                            <asp:Label ID="lblMobile" runat="server" CssClass="float-label" Text="Mobile Number"></asp:Label>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-3">
                    <div class="md-float-material form-material">
                        <div class="form-group form-primary">
                            ...
                            <span class="form-bar"></span>
                            <asp:Label ID="lblAddress" runat="server" CssClass="float-label" Text="Address"></asp:Label>
                        </div>
                    </div>
    ...
    <ItemTemplate>
        <div class="row">
            ...
            <div class="col-sm-1">
                ...
                <asp:LinkButton ID="btndel" runat="server" style="margin-left:15px" OnClick="btndel_Click"><i class="fa fa-minus" style="color:red;font-size:20px;margin-top:8px;" aria-hidden="true"></i></asp:LinkButton>
            </div>
        </div>
        <br />
    </ItemTemplate>
